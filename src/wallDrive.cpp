...
//         double x_meas = WALL_X_LEFT + (d_right + RIGHT_SENSOR_OFFSET);
//         x += conf_r * (x_meas - x);
//     }
//     else if (conf_r > conf_l && conf_r > 0.0f && 260 <= theta <= 270) {
//         double x_meas = WALL_Y_BACK - (d_right + RIGHT_SENSOR_OFFSET);
//         x += conf_r * (x_meas - x);
//     }
//     else if (conf_r > conf_l && conf_r > 0.0f && 80 <= theta <= 100) {
//         double x_meas = WALL_Y_FRONT + (d_right + RIGHT_SENSOR_OFFSET);
//         x += conf_r * (x_meas - x);
//     }
...
//         double x_meas = WALL_X_RIGHT - (d_left + LEFT_SENSOR_OFFSET);
//         x += conf_l * (x_meas - x);
//     }
//     else if (conf_l > 0.0f && 260 <= theta <= 280) {
//         double x_meas = WALL_Y_FRONT + (d_left + LEFT_SENSOR_OFFSET);
//         x += conf_l * (x_meas - x);
//     }
//     else if (conf_l > 0.0f && 80 <= theta <= 100) {
//         double x_meas = WALL_Y_BACK - (d_left + LEFT_SENSOR_OFFSET);
//         x += conf_l * (x_meas - x);
//     }
...
//         double y_meas = WALL_Y_BACK - (d_front + FRONT_SENSOR_OFFSET);
//         y += conf_f * (y_meas - y);
//     }
//     else if (conf_f > 0.0f && 80 <= theta <= 100) {
//         double y_meas = WALL_X_RIGHT - (d_front + FRONT_SENSOR_OFFSET);
//         y += conf_f * (y_meas - y);
//     }
//     else if (conf_f > 0.0f && 170 <= theta <= 180) {
//         double y_meas = WALL_Y_FRONT + (d_front + FRONT_SENSOR_OFFSET);
//         y += conf_f * (y_meas - y);
//     }
//     else if (conf_f > 0.0f && 260 <= theta <= 280) {
//         double y_meas = WALL_X_LEFT + (d_front + FRONT_SENSOR_OFFSET);
//         y += conf_f * (y_meas - y);
//     }
...
// void print_distance_readings() {
//     pros::lcd::print(0, "Left: %.2f", distance_in(leftDist));
//     pros::lcd::print(1, "Front: %.2f", distance_in(frontDist));
//     pros::lcd::print(2, "Front Right: %.2f", distance_in(rightDist));
//     pros::lcd::print(3, "Back Right: %.2f", distance_in(rightDistAlt));
// }

// void print_distance_robot_position() {
